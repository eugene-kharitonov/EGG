...
def main(params):
    ...
    receiver = Receiver(n_hidden=opts.receiver_hidden, n_dim=n_a * n_v)
    ...
    trainer = core.Trainer(
        ...
        callbacks=[core.ConsoleLogger(as_json=True, print_train_loss=True), metrics_evaluator]) #, EarlyStopperAccuracy(opts.early_stopping_thr)])#, intervention])
