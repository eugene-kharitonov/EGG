...
from egg.zoo.compositional_efficiency.archs import (Receiver, CircleSender, Lenses)
...
def main(params):
    ...
    train_data = SphereData(n_points=int(1e3))
    ...
    receiver = Receiver(n_hidden=opts.receiver_hidden, n_dim=2, inner_layers=opts.receiver_layers)
